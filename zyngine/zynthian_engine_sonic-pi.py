...
class zynthian_engine_puredata(zynthian_engine):
	...
	startup_patch = zynthian_engine.data_dir + "/presets/sonic-pi/zynthian_startup.pd"

	bank_dirs = [
		('EX', zynthian_engine.ex_data_dir + "/presets/sonic-pi"),
		('MY', zynthian_engine.my_data_dir + "/presets/sonic-pi"),
		('_', zynthian_engine.data_dir + "/presets/sonic-pi")
	]
	...
	def __init__(self, zyngui=None):
		...
		if self.config_remote_display():
			...
			self.base_command="".format(self.startup_patch)
